...
/**
 * create_file - function that creates a files in the project
 * @filename: name of the file to be created in the project
 * @text_content: context to be written in the project
