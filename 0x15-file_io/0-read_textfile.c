...
/**
 * read_textfile - read the content of a text files and prints
 * it to POXIS standard output in th e project
 * @filename: name of file to be read and printed in the project
 * @letters: number of letters it should read and print in the project
